...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (self.iconImageURLStringGroup.count > 0) {
        cell.icon.hidden = NO;
        [cell.icon sd_setImageWithURL:self.iconImageURLStringGroup[itemIndex] placeholderImage:[UIImage imageNamed:@"placeholder_head"]];
    }
