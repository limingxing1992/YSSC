...
@implementation UserOrderGoodsCell
...
- (void)setModel:(UserGoodsObject *)model{
    self.nameLabel.text = model.goodsname;
    self.goodsTypeLabel.text = [NSString stringWithFormat:@"%@：%@",model.attr_name,model.avalue];
    self.moneyLabel.text = [NSString stringWithFormat:@"¥%@",model.promotion_price];
    self.countLabel.text = [NSString stringWithFormat:@"×%@",model.quantity];
    [self.icon sd_setImageWithURL:model.pic placeholderImage:IMAGE(@"placeholder_loading")];
}
